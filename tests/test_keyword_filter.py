...
class TestKeywordFilter:
    def test_block_match_any_single_keyword(self):
        ...
        payload = {
            "messages": [
                {"role": "user", "content": "This contains the forbidden word."}
            ]
        }
    ...
    def test_block_match_all_avoid_partial_match(self):
        """Test that action is NOT taken when match_mode is 'all' and only some keywords are present."""
        config = {
        ...
        payload = {
            "messages": [
                {"role": "user", "content": "This is just secret but not the other one."}
            ]
        }
    ...
    def test_block_match_all_hit_full_match(self):
        ...
        payload = {
            "messages": [
                {"role": "user", "content": "This is both secret and confidential info."}
            ]
        }
    ...
    def test_sanitization(self):
        ...
        payload = {
            "messages": [
                {"role": "user", "content": "This has badwords in it."}
            ]
        }
        ...
        # Ensure original payload wasn't mutated if we were checking reference equality (though implementation does deepcopy)
    ...
    def test_logging_only(self):
        ...
        payload = {
            "messages": [
                {"role": "user", "content": "Please monitor this conversation."}
            ]
        }
    ...
    def test_case_sensitivity_match(self):
        ...
        payload = {
            "messages": [
                {"role": "user", "content": "This is STRICT uppercase."}
            ]
        }
    ...
    def test_multiple_messages_match_all(self):
        ...
        The implementation seems to scan all messages, assuming current implementation aggregates finding.
        Let's verify behavior. Based on reading, it iterates messages and adds to present_keywords.
