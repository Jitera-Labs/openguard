---
title: PII Filter
description: "OpenGuard pii_filter guard: automatically detect and redact PII — emails, phone numbers, SSNs, and credit card numbers — before they reach the LLM provider."
---
