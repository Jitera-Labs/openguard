...
description: "OpenGuard keyword_filter guard: block, redact, or audit LLM traffic containing specific keywords, secrets, or regex patterns. Full configuration reference."
---
