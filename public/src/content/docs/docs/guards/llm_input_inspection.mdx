---
title: LLM Input Inspection
description: "OpenGuard llm_input_inspection guard: detect prompt injections and jailbreaks using a secondary LLM. Semantic intent analysis beyond regex. Config and examples."
---
