...
description: "Install and run OpenGuard in under a minute. Set up the LLM security proxy for Claude Code, Codex, or any OpenAI-compatible agent with one command."
head:
  - tag: script
    attrs:
