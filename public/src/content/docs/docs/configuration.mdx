---
title: "Configuration: YAML Guard Rules, Env Vars, and Presets"
description: "Configure YAML guard rules, environment variables, request matching, and presets for an LLM security proxy with OpenGuard."
head:
  - tag: script
    attrs:
      type: application/ld+json
    content: '{"@context":"https://schema.org","@type":"TechArticle","name":"Configuration: YAML Guard Rules, Env Vars, and Presets","description":"Configure YAML guard rules, environment variables, request matching, and presets for an LLM security proxy with OpenGuard.","url":"https://openguard.sh/docs/configuration/","isPartOf":{"@type":"WebPage","name":"OpenGuard Docs","url":"https://openguard.sh/docs/"},"publisher":{"@type":"Organization","name":"OpenGuard","url":"https://openguard.sh/"}}'
---
