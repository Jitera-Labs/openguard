...
OPENGUARD_OPENAI_URLS = Config[str](
  ...
  description='Downstream OpenAI-compatible API URLs. Use wildcard naming like OPENGUARD_OPENAI_URL_OLLAMA.'
)
...
OPENGUARD_OPENAI_KEYS = Config[str](
  ...
  type=str,
  default='',
  description='API keys for downstream APIs. Use wildcard naming like OPENGUARD_OPENAI_KEY_OLLAMA.'
)
